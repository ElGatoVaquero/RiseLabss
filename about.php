...
<head>
    <title>Riselabs - Sobre nosotros</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    ...
                    <p>
                        En Riselabs nos especializamos en ofrecer suplementos deportivos de la más alta calidad para mejorar tu rendimiento y ayudarte a alcanzar tus metas. Creemos en la ciencia, la constancia y el poder de una buena nutrición para transformar tu cuerpo y tu salud.
                    </p>
                </div>
                <div class="col-md-4">
                    <img src="./ImagenesRiselabs/RopaDeportiva.png" alt="About Hero">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    En Riselabs trabajamos para ofrecerte la mejor experiencia de compra y acompañarte en cada paso de tu progreso físico.
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Devoluciones sencillas</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Atencion las 24 horas</h2>
                </div>
            </div>
        </div>
    </section>
