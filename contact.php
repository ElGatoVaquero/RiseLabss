...
<head>
    <title>Riselabs - Contactanos</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="./ImagenesRiselabs/LogoRiselabs.png">
    <link rel="shortcut icon" type="image/x-icon" href="/templatemo_559_zay_shop/ImagenesRiselabs/LogoRiselabs.png">
...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            ...
            <p>
                Estamos aquí para ayudarte. Si tienes dudas sobre nuestros productos, pedidos o colaboraciones, completa el formulario y te responderemos lo antes posible.
            </p>
        </div>
    </div>
...
<script>
  // Coonadasrde
  const lat = 17.97357142959303;
  const lng = -102.23155003794557;
  ...
  L.marker([lat, lng])
    .addTo(mymap)
    .bindPopup("<b>Riselabs</b><br>Ubicación.")
    .openPopup();
