...
$sql = $con->prepare("SELECT id, nombre, precio, peso  FROM productos WHERE id=1");
$sql->execute();
$resultadoC = $sql->fetchAll(PDO::FETCH_ASSOC);

$sql = $con->prepare("SELECT id, nombre, precio, peso  FROM productos WHERE id=2");
$sql->execute();
$resultadoPe = $sql->fetchAll(PDO::FETCH_ASSOC);

$sql = $con->prepare("SELECT id, nombre, precio, peso  FROM productos WHERE id=3");
$sql->execute();
$resultadoPr = $sql->fetchAll(PDO::FETCH_ASSOC);

$sql = $con->prepare("SELECT id, nombre, precio, talla  FROM productos WHERE id=4");
$sql->execute();
$resultadoR = $sql->fetchAll(PDO::FETCH_ASSOC);

$sql = $con->prepare("SELECT id, nombre, precio, peso, talla, imagen  FROM productos WHERE stock>0");
$sql->execute();
    ...
    <div class="col-md-4">
        <div class="card mb-4 product-wap rounded-0">
            <div class="card rounded-0">
                <img class="card-img rounded-0 img-fluid" src="./ImagenesRiselabs/<?php echo $row['imagen']; ?>">
                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                    <ul class="list-unstyled">
                        <li><a class="btn btn-success text-white" href="shop-single-<?php echo $row['nombre']; ?>.php"><i class="far fa-heart"></i></a></li>
                        <li><a class="btn btn-success text-white mt-2" href="shop-single-<?php echo $row['nombre']; ?>.php"><i class="far fa-eye"></i></a></li>
                        <li><a class="btn btn-success text-white mt-2" href="shop-single-<?php echo $row['nombre']; ?>.php"><i class="fas fa-cart-plus"></i></a></li>
                    </ul>
                </div>
            </div>
            <div class="card-body">
                <a href="shop-single-<?php echo $row['nombre']; ?>.php" class="h3 text-decoration-none"><?php echo $row['nombre']; ?></a>
                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    <li><?php echo isset($row['peso']) ? $row['peso'] : $row['talla']; ?></li>
                </ul>
        ...
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        En Riselabs trabajamos con las mejores marcas del mercado fitness, garantizando productos de calidad, seguridad y resultados reales para nuestros clientes.
                    </p>
                </div>
