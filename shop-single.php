...
<body>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" id="product-detail"
                        src="./ImagenesRiselabs/<?= $producto['imagen']; ?>">
                </div>

                <!-- Miniaturas (usa la misma imagen repetida) -->
                <div class="row">
                    <div class="col-3">
                        <img class="img-fluid" src="./ImagenesRiselabs/<?= $producto['imagen']; ?>">
                    </div>
                    <div class="col-3">
                        <img class="img-fluid" src="./ImagenesRiselabs/<?= $producto['imagen']; ?>">
                    </div>
            ...
            <div class="col-lg-7 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6>Contenido:</h6>
                        <p><?= $producto['peso'] ? $producto['peso'] : $producto['talla']; ?></p>

                        <h6>Especificaciones:</h6>
                        <p><?= nl2br($producto['especificaciones']); ?></p>

                        <!-- Cantidad -->
                        <div class="d-flex align-items-center my-3">
                            <button class="btn btn-dark">-</button>
                            <input type="text" value="1" class="form-control mx-2" style="width: 60px;">
                            <button class="btn btn-dark">+</button>
                        </div>

                        <!-- BOTÓN PAYPAL -->
                        <div class="my-3">
                            <button class="btn btn-primary w-100">Pagar con PayPal</button>
                        </div>

                        <!-- BOTÓN TARJETA -->
                        <div>
                            <button class="btn btn-dark w-100">Tarjeta de débito o crédito</button>
                        </div>
